...
// methods to add and create member profile in fire base
  createMemberProfile({
    ...
    await FirebaseFirestore.instance
      ...
      'name': name,
      'email': email,
      'imageUrl': file.path == "" ? "https://firebasestorage.googleapis.com/v0/b/eshraf-9b0ba.appspot.com/o/user.png?alt=media&token=9d9b6b7d-f436-4fd3-99a2-e5b8bdf6f8d1" : imageUrl,
      'id': id,
      'fields': fields,
      'degree': degree,
      'link': link,
